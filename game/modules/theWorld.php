...
if(!$smarty->isCached('theWorld/worldGrid.tpl')) {
  ...
  $templateVariables2['stats'] = $stats;
  $templateVariables2['leftSide'] = $leftSide;
  $templateVariables2['rightSide'] = $rightSide;
  $templateVariables2['config'] = $config;
  ...
  include ('includes/constants/skills.php');
	...
	$templateVariables2['skills'] = $skills;
  $smarty->assign($templateVariables2);
}
$templateVariables["theTime"]    = date("H:i", time());
$templateVariables["worldGrid"] = $smarty->fetch("theWorld/worldGrid.tpl");
$smarty->caching = 0;
$templateVariables["display"] = "theWorld/theWorld.tpl";
