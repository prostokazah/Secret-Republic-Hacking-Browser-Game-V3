...
if ($GET["myReward"])
{
  ...
  if ($reward["reward_id"])
  {
    ...
    $templateVariables["reward"] = $reward;
    $templateVariables["display"] = "rewards/reward.tpl";
...
else
{
  ...
  $templateVariables["rewards"] = $rewards;
  $templateVariables["display"] = "rewards/rewards.tpl";
}
