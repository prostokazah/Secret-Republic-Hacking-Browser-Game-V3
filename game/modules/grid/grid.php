...
elseif ($GET['layers'])
{
	...
	$templateVariables['display'] = "grid/layers.tpl";
}
else
{
	...
	else
	{
	  ...
	  $templateVariables['cluster']    = $cluster;

	  $templateVariables['clusterNodes']    = $clusterNodesFinal;
	  
	  $templateVariables['display']     = 'grid/grid.tpl';
	}
}

$templateVariables['currentCluster'] = $currentCluster;
$templateVariables['currentZone'] = $currentZone;
$templateVariables['userNode'] = $userNode;
