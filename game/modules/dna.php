...
if ($GET['sessions'])
{
	$templateVariables['load'] = 'sessions';
	...
	$templateVariables['sessions'] = $sessions;
}
else
{
  ...
  $templateVariables["youtube"] = $credentials['youtube'];
  $templateVariables["email"] = $credentials['email'];
  $templateVariables["no_pass"] = $no_pass;
}

  $templateVariables["display"] = 'dna/dna.tpl';
