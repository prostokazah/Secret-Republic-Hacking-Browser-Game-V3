...
if(!$logged && $_GET['reset'])
{
	...
	$templateVariables['display']= 'forgot_password/change_password.tpl';
...
elseif (!$logged && $GET["forgot"])
{
  ...
  $templateVariables["display"] = 'forgot_password/request_email.tpl';
}
elseif (!$logged)
{
  ...
  $templateVariables["display"] = 'home/reg_form.tpl';

}else $cardinal->redirect(URL);

			$templateVariables["no_footer_bar"] = true;
?>
