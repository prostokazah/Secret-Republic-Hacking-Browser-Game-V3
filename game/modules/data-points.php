...
$templateVariables['spin1comps'] = implode(", ", $spin1compNames);
$templateVariables['spin1apps'] = implode(", ", $spin1appNames);
$templateVariables['spin1Costs'] = $spin1Costs;
$templateVariables['spin1SuccessRate'] = $spin1SuccessRate;
$templateVariables['display'] = 'data-points/data-points.tpl';