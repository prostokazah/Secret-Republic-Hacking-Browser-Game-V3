...
if (!$user['in_party'])
{
  if ($_POST['create'])
  {
    ...
    $templateVariables['invitations'] = $invitations;
...
else
{
  ...
  $templateVariables['invitees'] = $invitees;
  $templateVariables['party'] = $party;
  
}
$templateVariables['display'] = 'parties/parties.tpl';
