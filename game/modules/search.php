...
$cardinal->mustLogin();
	  ...
	  else
	  {
        if($GET["type"]=="user"){
          ...
          if ($cardinal->loginSystem->validateUsername($search))
          {
              ...
              $templateVariables["count"] = $results["nrUsers"];
        ...
        elseif($GET["type"]=="org")
        {
              ...
              $templateVariables["count"] = $results["nrOrgs"];
                  $pages = new Paginator;
        ...
        elseif($GET["type"]=="blog")
        {
          ...
          if ($bclass->validateBlogTitle($search))
          {
           ...
           $templateVariables["count"] = $results["nrBlogs"];
        ...
        elseif($GET["type"]=="article")
        {
          ...
          if ($bclass->validateBlogTitle($search))
          {
           ...
           $templateVariables["count"] = $results["nrArticles"];
	...
	$templateVariables["results"] = $results;
	$templateVariables["display"] = 'search/search.tpl';
