...
if ($GET['simulation'])
{
	...
	$templateVariables['attack'] = $simulation;
	$templateVariables['simulation'] = true;
	...
	if (!$_SESSION['premium']['attackSimulator'])
{
	...
	$templateVariables['skills'] = $skills;
	$templateVariables['display'] = "simulator/simulator.tpl";
}
else
{
	...
	$templateVariables['simulations'] = $simulations;
	$templateVariables['display'] = "simulator/simulations.tpl";
}
