...
elseif (isset($_POST['mount']))
{
	...
	$templateVariables['loadd']    = $load;
	$templateVariables['load'] = 'mount_component';
	$templateVariables['display'] = 'storage/storage.tpl';
}
else
{
	...
	$templateVariables['availableSlots'] = $availableSlots;
