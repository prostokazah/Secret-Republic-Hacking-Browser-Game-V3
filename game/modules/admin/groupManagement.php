...
if (!defined('cardinalSystem')) exit;	
  ...
  $templateVariables["nonPermissionColumns"] = $nonPermissionColumns;
  $templateVariables["ignoreColumns"] = $ignoreColumns;
  ...
  $templateVariables["display"] = 'admin/groups/groups.tpl';
