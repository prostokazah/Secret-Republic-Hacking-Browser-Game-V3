...
if ($GET['new'])
{
  ...
  $templateVariables["display"] = 'conversations/new_message.tpl';
}
elseif ($message_id = $GET['message'])
{
	...
	if ($message['message_id'])
	{
	  ...
	  $templateVariables['replyNotAllowed'] = $replyNotAllowed;
	  $templateVariables['replies'] = $replies;
	  $templateVariables['display'] = 'conversations/message.tpl';
...
else
{
  ...
  $templateVariables["display"] = 'conversations/messages.tpl';
}
