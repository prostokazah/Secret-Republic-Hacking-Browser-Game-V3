...
if ($GET["latestArticles"])
  ...
  elseif ($GET["create"] && $logged) {
      ...
      $templateVariables["display"] = 'blog/blog_create.tpl';
  ...
  elseif ($GET["myown"] && $logged) {
    ...
    $templateVariables["blogs"]   = $blogs;
    $templateVariables["display"] = 'blog/blog_main_list.tpl';
    ...
    if (!$blog["blog_id"])
      ...
      if ($user["id"] == $blog["user_id"]) {
        ...
        if ($GET["add"] == "article") {
          ...
          $templateVariables["display"] = "blog/blog_add_article.tpl";
        } //$GET["add"] == "article"


      } // of blog owner

      if (!$templateVariables["display"]) {
        ...
        $templateVariables["display"] = "blog/blog_show.tpl";
      } //!$templateVariables["display"]
      $templateVariables["blog"] = $blog;
    }
  } //$GET["blog"]
  else
  {
    ...
    $templateVariables['blogs'] = $blogs;
    $templateVariables["display"] = 'blog/blogs.tpl';
  }
}
?>
