...
$page_title="Friendships";
  ...
  $pages->paginate();
    ...
    $templateVariables["requests"] = $requests;
    $templateVariables["display"] = "friends/friend_requests.tpl";
    ...
    $templateVariables["nrf"] = $friendsNumber['nrf'];
    $templateVariables["friends"] = $friends;
    $templateVariables["display"] = "friends/friends.tpl";
  }
