...
if ($GET['note'])
{
	...
	$templateVariables['note'] = $note;
	$templateVariables['display'] = "notes/note.tpl";
...
$templateVariables['nrNotes'] = $nrNotes;
$templateVariables['maxContentSize'] = $maxContentSize;
$templateVariables['notes'] = $notes;
$templateVariables['display'] = "notes/notes.tpl";
}
