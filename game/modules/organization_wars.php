...
$templateVariables['war'] = $war; 
$templateVariables['display'] = 'organization_wars/view_war.tpl'; 
...
if ($war['status'] == 2 && $user['organization'])
{
  ...
  if (!$fightTask['id'])
  {
	...
	$templateVariables['canFight'] = $canFight;
  }
  else
  {
    $templateVariables["qtask"] = $fightTask;
...
{	
	...
	$templateVariables['inprogress'] = $inprogress;
	$templateVariables['wars'] = $wars;
 	$templateVariables['display'] = "organization_wars/org_wars.tpl";
}
