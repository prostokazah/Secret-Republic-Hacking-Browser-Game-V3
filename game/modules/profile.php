	...
	if(!$quser['id'])
      ...
      if (!$quser['banned'])
      {
		  ...
		  if ($logged && $quser['id']!=$user['id'])
		  {
				  ...
				  $templateVariables['areFriends'] = $areFriends;
				  $templateVariables['waitingRequest'] = $waitingRequest;
		  ...
		  $templateVariables['forumThreads'] = $forumThreads;
		  $templateVariables['blogs']        = $blogs;
		  $templateVariables['achievements'] = $achievements;

	} // not banned
		$templateVariables['quser'] = $quser;
		$templateVariables['display'] = 'profile/profile.tpl';
