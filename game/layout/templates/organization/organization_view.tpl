        ...
        <div class="col-md-9">
          <div class="text-center">
            ...
            <div class="futureNav middle"> 
              ...
              {if $access}
                <!--
                  <li><a href="{$config.url}organization/show/{$org.id}/"><span class="glyphicon glyphicon-eye-open"></span></a></li>-->
                   <li><a href="{$config.url}organization/show/{$org.id}/view/chat"><span class="glyphicon glyphicon-bullhorn"></span></a></li>		
