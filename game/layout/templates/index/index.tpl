  ...
  <div class="col-md-6 ">
    ...
    <div class="row">
      ...
      <div class="col-md-6 ">
        ...
        <iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2FtheSecretRepublic&amp;width&amp;layout=button_count&amp;action=like&amp;show_faces=false&amp;share=false&amp;height=21&amp;appId=820318067994880&amp;colorscheme=dark" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height:21px;width: 80px; display:inline" allowtransparency="true">
            </iframe>
          </div>
          <!--
        <iframe  class="youtubeIntro alphaGlow mb10 imageOpacity" src="http://www.youtube.com/embed/?list=PLHxmav9PZJKaiBGqv_2gOxpGhKmtY3j7V&loop=1&origin=http://secretrepublic.net&autohide=1&modestbranding=1&showinfo=0" frameborder="0" style="width:100%;border:1px solid rgba(70, 120, 185, 0.4);margin-left:0px;height:100px;margin-top:0"></iframe>
-->
