...
function myErrorHandler($errno, $errstr, $errfile, $errline)
{
  ...
  if (in_array($errno, $report) && isset($errstr)) {
	  global $smarty, $templateVariables, $GET, $config;
	...
	if ($smarty) {
		//if ($cardinal->user['view_debug'])
		  $templateVariables['insertData'] = var_export($insertData, true);
...
{
  global $errors, $error, $GET, $info, $myModals, $messenger,$templateVariables, $no_warning_voice,$voice, $success, $page_start, $pages, $page_title, $page, $user, $logged, $config, $alert, $warnings, $cardinal;
  ...
  if ($pages->num_pages) {
    ...
    $templateVariables['pages']     = $pages->display_pages();
  ...
  $templateVariables = array_merge($templateVariables, $moreTemplateVariables);
